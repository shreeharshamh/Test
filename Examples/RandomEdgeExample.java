...
public class RandomEdgeExample {
    ...
    public RandomEdgeExample()
    {
        // Set a maximum limit for the number of vertices, say 20
        this.vertices = random.nextInt(MAX_LIMIT);
    ...
    public static void main(String[] args)
    {
        ...
        RandomEdgeExample randomGraph = new RandomEdgeExample();
